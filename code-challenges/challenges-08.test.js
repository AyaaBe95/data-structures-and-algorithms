...
const typeNum = (arr) => {
  // Solution code here...
  let numberArr = arr.filter( function(x,i) {
...
const oddValues = (arr) => {
  // Solution code here...
  let oddArray = arr.filter( function(x,i) {
    return (x % 2);
  });
 return oddArray;
};
...
const filterStringsWithVowels = (arr) => {
  // Solution code here...
  let regex = /[aeiou]/i
  let dataArray = arr.filter( function(n,i) {
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let resultArray = arr.filter(function(x,i){
